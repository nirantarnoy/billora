...
CREATE TABLE `backup_history` (
  ...
  `remote_status` enum('pending','success','failed','skipped') DEFAULT 'skipped',
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='ตารางประวัติการ Backup';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `backup_history` VALUES (1,NULL,'backup_full_2026-02-03T03-42-41.sql','D:\\NodeJs_Project\\billora\\backups\\backup_full_2026-02-03T03-42-41.sql',61043,'manual','success','skipped',NULL,NULL,NULL,NULL,NULL,'2026-02-03 03:42:42',NULL),(2,NULL,'backup_full_2026-02-03T04-14-11.sql','D:\\NodeJs_Project\\billora\\backups\\backup_full_2026-02-03T04-14-11.sql',61574,'manual','success','skipped',NULL,NULL,NULL,NULL,NULL,'2026-02-03 04:14:11',NULL),(3,NULL,'backup_tenant_null_2026-02-03T04-14-25.sql','D:\\NodeJs_Project\\billora\\backups\\backup_tenant_null_2026-02-03T04-14-25.sql',12258,'manual','success','skipped',NULL,NULL,NULL,NULL,NULL,'2026-02-03 04:14:25',NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=24 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='ตารางกำหนดการ Backup อัตโนมัติ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `backup_schedules` VALUES (17,NULL,'Weekly Full Backup','สำรองข้อมูลทั้งหมดทุกวันอาทิตย์เวลา 03:00 AM','0 3 * * 0','full',30,10,0,NULL,NULL,0,1,NULL,'none',NULL,22,NULL,NULL,'/','2026-02-04 10:15:46','2026-02-04 10:15:46',NULL);
...
CREATE TABLE `inventory_balances` (
  ...
  `location_id` int(11) DEFAULT NULL COMMENT 'NULL if general warehouse area',
  `lot_id` int(11) DEFAULT NULL COMMENT 'NULL if no lot control',
  ...
  KEY `lot_id` (`lot_id`),
  KEY `idx_balance_product` (`product_id`),
  CONSTRAINT `inventory_balances_ibfk_1` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`) ON DELETE CASCADE,
  CONSTRAINT `inventory_balances_ibfk_2` FOREIGN KEY (`warehouse_id`) REFERENCES `warehouses` (`id`) ON DELETE CASCADE,
  CONSTRAINT `inventory_balances_ibfk_3` FOREIGN KEY (`location_id`) REFERENCES `warehouse_locations` (`id`) ON DELETE SET NULL,
  CONSTRAINT `inventory_balances_ibfk_4` FOREIGN KEY (`lot_id`) REFERENCES `inventory_lots` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='ตารางยอดคงเหลือสินค้าแยกตามคลัง/ตำแหน่ง/Lot';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `inventory_balances` VALUES (1,1,1,1,1,1,79.00,'2026-02-04 12:31:16');
...
CREATE TABLE `inventory_lots` (
  ...
  KEY `idx_lot_exp` (`exp_date`),
  CONSTRAINT `inventory_lots_ibfk_1` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='ตารางเก็บข้อมูล Lot สินค้า';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `inventory_lots` VALUES (1,1,1,'26020001','2026-02-04','2026-02-28',0.00,0.00,0.00,NULL,'2026-02-04 10:38:39','2026-02-04 10:38:39');
...
CREATE TABLE `inventory_transactions` (
  ...
  `reference_no` varchar(100) DEFAULT NULL COMMENT 'เลขที่อ้างอิง (Order ID, PO No)',
  ...
  KEY `location_id` (`location_id`),
  KEY `lot_id` (`lot_id`),
  KEY `idx_trans_product` (`product_id`),
  ...
  CONSTRAINT `inventory_transactions_ibfk_2` FOREIGN KEY (`warehouse_id`) REFERENCES `warehouses` (`id`) ON DELETE CASCADE,
  CONSTRAINT `inventory_transactions_ibfk_3` FOREIGN KEY (`location_id`) REFERENCES `warehouse_locations` (`id`) ON DELETE SET NULL,
  CONSTRAINT `inventory_transactions_ibfk_4` FOREIGN KEY (`lot_id`) REFERENCES `inventory_lots` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='ตารางความเคลื่อนไหวสินค้า';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `inventory_transactions` VALUES (1,1,'2026-02-04 17:38:39','ADJUSTMENT',1,1,1,1,100.00,NULL,'Stock In','xx',1,'2026-02-04 10:38:39',0.00,0.00,0.00),(2,1,'2026-02-04 17:39:17','ISSUE',1,1,1,1,-20.00,NULL,'Use','xx',1,'2026-02-04 10:39:17',0.00,0.00,0.00),(3,1,'2026-02-04 17:41:04','RETURN',1,1,1,1,20.00,NULL,'Return','',1,'2026-02-04 10:41:04',0.00,0.00,0.00),(4,1,'2026-02-04 00:00:00','ISSUE',1,1,1,1,-1.00,'ISS-20260204-0004','Stock Out','',1,'2026-02-04 12:17:42',0.00,1.00,0.00),(5,1,'2026-02-04 00:00:00','ISSUE',1,1,1,1,-20.00,'ISS-20260204-0005','Stock Out','',1,'2026-02-04 12:31:16',0.00,20.00,0.00);
...
CREATE TABLE `products` (
  ...
  `code` varchar(100) DEFAULT NULL COMMENT 'รหัสสินค้า',
  `user_id` int(11) NOT NULL,
  `sku` varchar(50) NOT NULL,
  `name` varchar(255) NOT NULL,
  `description` text DEFAULT NULL,
  `unit_id` int(11) DEFAULT NULL COMMENT 'หน่วยนับ',
  `price` decimal(10,2) DEFAULT 0.00,
  `cost` decimal(10,2) DEFAULT 0.00,
  `sale_price` decimal(15,2) DEFAULT 0.00 COMMENT 'ราคาขาย',
  `avg_cost` decimal(15,2) DEFAULT 0.00 COMMENT 'ต้นทุนเฉลี่ย',
  `image_urls` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT 'เก็บรายการรูปภาพมากสุด 4 รูป' CHECK (json_valid(`image_urls`)),
  ...
  `multiple_qty` decimal(10,2) DEFAULT 1.00,
  PRIMARY KEY (`id`),
...
INSERT INTO `products` VALUES (1,1,'001',0,'X123444','Factorium EN ALL in One','',NULL,0.00,0.00,0.00,0.00,'[]','active',NULL,'2026-02-03 12:30:00','2026-02-04 12:30:50',90.00,120.00,90.00);
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='ตารางตำแหน่งจัดเก็บสินค้า';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `warehouse_locations` VALUES (1,1,1,'loc_01','','active','2026-02-03 12:21:17','2026-02-03 12:21:17');
...
CREATE TABLE `warehouses` (
  ...
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  PRIMARY KEY (`id`),
  KEY `idx_warehouse_tenant` (`tenant_id`,`code`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='ตารางคลังสินค้า';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `warehouses` VALUES (1,1,'52305','Test','','active','2026-02-03 12:20:44','2026-02-03 12:20:44');
/*!40000 ALTER TABLE `warehouses` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping routines for database 'bill_ocr'
--
...
-- Dump completed on 2026-02-05  9:05:30
